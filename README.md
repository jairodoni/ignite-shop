...
#### Sistema Online: https://ignite-shopp.vercel.app

<br/>


## **💻 Projeto**
O projeto "Ignite Shop 2.0" é uma aplicação web/e-commerce para compras de múltiplos produtos originais da Rocketseat. Esse projeto é um dos desafios da trilha de React do Ignite.
...
Você pode visualizar o layout do projeto no formato através [desse link](https://www.figma.com/file/pG4gBQZMAl1wOMWfX7a8eI/Ignite-Shop-2.0-%E2%80%A2-Desafio-React-(JD)?type=design&node-id=2%3A12&mode=design&t=nmTbsqFaLSkJcLVm-1). Lembrando que você irá precisar ter uma conta no [Figma](http://figma.com/).
